...
public class InventoryUI : MonoBehaviour
{
    ...
    private void UpdateInteractionUI()
    {
        ...
        // Find nearest chest
        ChestInteractable nearestChest = FindNearestChest();

        // Prioritize pickups over chests
        ...
        else if (nearestChest != null && nearestChest.IsPlayerInRange())
        {
            currentPickup = null;
            ...
            if (interactionText != null)
            {
                interactionText.text = "'E' Abrir Cofre";
            }
        }
        else
        {
    ...
    private ChestInteractable FindNearestChest()
    {
        ChestInteractable[] chests = FindObjectsOfType<ChestInteractable>();
